#ifndef __RENDERING_SKELETON_HPP__
#define __RENDERING_SKELETON_HPP__
...
namespace rendering {
    ...
    class skeleton {
        ...
        friend class animated_mesh;

        std::vector<bone> bones_;
        std::unordered_multimap<int, int> bone_hierachy_;
        std::unordered_map<std::string, rendering::animation> animations_;
    public:
        skeleton(renderer& renderer, const std::vector<char>& source, const std::string& file_name) noexcept;
